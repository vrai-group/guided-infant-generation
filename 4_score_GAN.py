...
def save_img(i, name_dir_to_save_img, image_raw_0, image_raw_1, pose_1, mask_1, mean_0, mean_1, output_G1, output_G2, predizione, pz_0, pz_1,
    ...
    columns = 7
    rows = 1
    imgs = [predizione, output_G2, output_G1, predizione-output_G1, image_raw_0, pose_1, image_raw_1, mask_1]
    labels = ["Predizione","G2","G1","Diff", "Immagine di condizione", "Posa desiderata", "Target", "Maschera posa desiderata"]
