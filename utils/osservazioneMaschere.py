...
def _format_data(config, pz_0, pz_1, annotations_0, annotations_1):
    ...
    pose_peaks_0 = np.zeros(
        [16, 8, config.keypoint_num])  # dimensioni maschere 16x8 con 14 heatmap una per ogni keypoint
    ...
    example = tf.train.Example(features=tf.train.Features(feature={
        ...
        # immagine con shape [16, 8, 14] in cui sono individuati i keypoint dell'immagine 0 NON a raggio 4
        'pose_peaks_1': dataset_utils.float_feature(pose_peaks_1.flatten().tolist()),
        # immagine con shape [16, 8, 14] in cui sono individuati i keypoint dell'immagine 1 NON a raggio 4
